        ...
        >
            ...
            >
              ...
              ></span>
                    ...
                    <!-- Dropdown Start -->
                    @php($notifications = \App\Models\Notification::all())
                    <div
                        x-show="dropdownOpen"
                    ...
                    >
                      ...
                      <span>5 min ago</span>
                            ...
                            @else
                                <li>
                                    <span class="block">
                                    <span class="text-theme-sm mb-1.5 align-middle text-center block text-gray-500 dark:text-gray-400">
                                      <span class="font-medium text-center text-gray-800 dark:text-white/90">
